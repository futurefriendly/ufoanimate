...
theme:"balupton",themes:["balupton"],addSparkleExtension:true,prettifyBaseUrl:"https://www.futurefriendly.cn/ufoanimate/demo/jquery-syntaxhighlighter/prettify",baseUrl:"https://www.futurefriendly.cn/ufoanimate/demo/jquery-syntaxhighlighter"},init:function(b){var c=this.config,d=c.baseUrl;if(d[d.length-1]==="/")c.baseUrl=d.substr(0,d.length-2);delete d;a.extend(true,this.config,b||{});a.Sparkle&&a.Sparkle.addExtension("syntaxhighlighter",function(){a(this).syntaxHighlight()});a.fn.syntaxHighlight=a.fn.SyntaxHighlight=this.fn;c.load&&this.load();
